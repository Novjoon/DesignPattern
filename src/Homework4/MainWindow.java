...
public class MainWindow extends FrameWindow implements ActionListener {
    ...
    public MainWindow(String title) {
        ...
        Creator c = ConcreteCreator.getInstance();
        textFieldWindow=c.factoryMethod("text", TEXTFIELD_WINDOW_TITLE, X, Y + HEIGHT + GAP, WIDTH, HEIGHT);
        labelWindow=c.factoryMethod("label", LABEL_WINDOW_TITLE, X, Y + (HEIGHT + GAP) * 2, WIDTH, HEIGHT);
